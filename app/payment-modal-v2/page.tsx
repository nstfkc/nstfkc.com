...
const PrimaryButton = ({
  ...
  return (
    <button
      {...buttonProps}
      className="w-full rounded-[10px] bg-orange-500 p-[1px]"
    >
      <div className="w-full h-full flex items-center gap-2 justify-center px-4 py-2 text-sm text-white">
        {children}
      </div>
    </button>
  );
...
const SecondaryButton = ({
  ...
  return (
    <button
      {...buttonProps}
      className="w-full rounded-[12px] p-[1px] opacity-75"
    >
      <div className="w-full h-full flex items-center justify-center rounded-[10px] px-4 py-2 text-sm text-orange-600">
        {children}
      </div>
    </button>
  );
...
const CircleButton = ({
  ...
  return (
    <button
      {...buttonProps}
      className="group size-10 rounded-full p-[1px] active:bg-neutral-800 opacity-75"
    >
      <div className="w-full h-full flex items-center justify-center rounded-full text-xl text-orange-600">
        {children}
      </div>
    </button>
  );
