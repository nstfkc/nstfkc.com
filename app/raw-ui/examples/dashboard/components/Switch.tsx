...
export const Switch = (props: ComponentProps<typeof Root>) => {
  return (
    <Root
      className="border border-stone-600 w-[36px] h-[21px] bg-stone-600 rounded-full relative bg-stone-400 data-[state=checked]:bg-stone-700 outline-none cursor-default"
